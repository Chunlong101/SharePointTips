...
# How to use: Change the passwords in AD Users and Computers, then just run this script on every sharepoint server (one by one), it will automatically take care of all steps to reset passwords for sharepoint/iis application pool/windows service. 
# -----
